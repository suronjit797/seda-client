...
const DeviceView = () => {
  ...
  const getDeviceParameters = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/device/device-parameters/` + deviceId,
      { withCredentials: true }
    );
    if (response) {
      setDeviceParameters(
        response.data.sort((a, b) => (a._id > b._id ? 1 : -1))
      );
    }
  };
  ...
  const getFormulas = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/formula`,
      { withCredentials: true }
    );
    if (response) {
  ...
  const getDeviceFormulas = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/formula/device/` + deviceId,
      { withCredentials: true }
    );
    if (response) {
  ...
  const UnassignFormula = async (Id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${process.env.REACT_APP_API_URL}/formula/` + Id, {
            withCredentials: true,
          })
          .then((res) => {
            getDeviceFormulas();
            ...
            <div className="card p-3 mb-3">
              ...
              <div className="row mt-4">
                <div className="col-md-12">
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-9">
                      : {deviceDetails?.site?.installer?.name}
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-md-12 d-flex justify-content-end">
                  <Link to="/devices" className="btn btn-success me-2">
                    Edit
                  </Link>
                ...
                <div className="row mb-2">
                  ...
                  <div className="col-md-12">
                    <AssignedDeviceFormula
                      ...
                      UnassignFormula={UnassignFormula}
                    />
                  </div>
                </div>
                    ...
                    <div className="col-md-2">
                      {selectedFormula ? (
                        <input
                          type="text"
                          className="form-control"
                          value={selectedFormula?.formulaParts?.valueOne}
                          disabled
                        />
                      ) : (
                        <input
                    ...
                    <div className="col-md-2">
                      {selectedFormula ? (
                        <input
                          type="text"
                          className="form-control"
                          value={selectedFormula?.formulaParts?.valueTwo}
                          disabled
                        />
                      ) : (
                        <input
                    ...
                    <div className="col-md-2">
                      {selectedFormula ? (
                        <input
                          type="text"
                          className="form-control"
                          value={selectedFormula?.formulaParts?.valueThree}
                          disabled
                        />
                      ) : (
                        <input
                    ...
                    <div className="col-md-2">
                      {selectedFormula ? (
                        <input
                          type="text"
                          className="form-control"
                          value={selectedFormula?.formulaParts?.valueFour}
                          disabled
                        />
                      ) : (
                        <input
                    ...
                    <div className="col-md-2">
                      {selectedFormula ? (
                        <input
                          type="text"
                          className="form-control"
                          value={selectedFormula?.formulaParts?.valueFive}
                          disabled
                        />
                      ) : (
                        <input
                              ...
                              case "parameter":
                                return (
                                  <select
                                    ...
                                    value={valueOne}
                                    onChange={(e) =>
                                      handleChange(e.target.value, "valueOne")
                                    }
                                    className="form-select"
                                  >
                              ...
                              case "parameter":
                                return (
                                  <select
                                    ...
                                    value={valueTwo}
                                    onChange={(e) =>
                                      handleChange(e.target.value, "valueTwo")
                                    }
                                    className="form-select"
                                  >
                                    <option>Select Parameter</option>
                              ...
                              case "parameter":
                                return (
                                  <select
                                    ...
                                    value={valueThree}
                                    onChange={(e) =>
                                      handleChange(e.target.value, "valueThree")
                                    }
                                    className="form-select"
                                  >
                                    <option>Select Parameter</option>
                              ...
                              case "parameter":
                                return (
                                  <select
                                    ...
                                    value={valueFour}
                                    onChange={(e) =>
                                      handleChange(e.target.value, "valueFour")
                                    }
                                    className="form-select"
                                  >
                                    <option>Select Parameter</option>
                              ...
                              case "parameter":
                                return (
                                  <select
                                    ...
                                    value={valueFive}
                                    onChange={(e) =>
                                      handleChange(e.target.value, "valueFive")
                                    }
                                    className="form-select"
                                  >
                                    <option>Select Parameter</option>
